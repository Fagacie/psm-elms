    ...
    <div class="content-wrapper">
        ...
        <section class="admin-page-head">
            <div class="admin-breadcrumb">
                ...
                <span>&gt;</span>
                <a href="${pageContext.request.contextPath}/admin/payments">Payment</a>
                <span>&gt;</span>
            ...
            <div class="admin-hero">
                <div class="admin-hero-copy">
                    ...
                    <p>The detail view keeps the record focused on the important operational fields only.</p>
                </div>
                <div class="admin-hero-scene" aria-hidden="true">
                    <div class="admin-scene-panel"><span>Status</span><strong>${payment.status}</strong></div>
                    <div class="admin-scene-panel"><span>Amount</span><strong>₦<fmt:formatNumber value="${payment.amount}" type="number" minFractionDigits="2" maxFractionDigits="2"/></strong></div>
                </div>
            </div>
        </section>
        </c:if>
        ...
        <section class="section-card">
            ...
            <div class="metrics-grid">
                <div class="metric-card">
                    ...
                    <div class="metric-value">₦<fmt:formatNumber value="${payment.amount}" type="number" minFractionDigits="2" maxFractionDigits="2"/></div>
                </div>
                <div class="metric-card">
