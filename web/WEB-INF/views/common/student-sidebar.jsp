...
<aside class="sv-sidebar" id="svSidebar">
    <nav class="sv-nav">
        ...
        <a href="${pageContext.request.contextPath}/student/materials" class="sv-nav-link ${activePage == 'materials' ? 'active' : ''}"><i class="fas fa-folder-open"></i><span>Materials</span></a>
        ...
        <c:if test="${showReports == true}">
            <a href="${pageContext.request.contextPath}/reports" class="sv-nav-link ${activePage == 'reports' ? 'active' : ''}"><i class="fas fa-chart-column"></i><span>Reports</span></a>
        </c:if>
