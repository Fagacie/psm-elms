...
<nav class="sv-topbar">
    ...
    <div class="sv-top-right">
        <a href="${pageContext.request.contextPath}/profile" class="cert-user">
            <span class="cert-user-icon">
                <c:choose>
                    <c:when test="${not empty topbarProfilePath}">
                        <c:choose>
                            <c:when test="${fn:startsWith(topbarProfilePath, 'http')}"><img src="${topbarProfilePath}" alt="Profile" class="cert-avatar-img"></c:when>
                            <c:otherwise><img src="${pageContext.request.contextPath}${topbarProfilePath}" alt="Profile" class="cert-avatar-img"></c:otherwise>
                        </c:choose>
                    </c:when>
