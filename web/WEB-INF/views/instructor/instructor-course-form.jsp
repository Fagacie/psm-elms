    ...
    <main class="app-main">
        <div class="content-wrapper">
            ...
            <div class="ins-two-col">
                <div class="form-section" style="max-width: 100%; margin: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <c:if test="${mode == 'edit' && not empty course.courseBanner}">
                                    <div style="margin-top:12px;">
                                        <img src="${course.courseBanner}" alt="Current course banner" class="course-banner-preview" style="border-radius:12px;">
                                    </div>
                                </c:if>
                            </div>
                ...
                <div class="ins-stack">
                    <section class="ins-hero-card" style="margin-bottom:0;">
                        <div>
                            <h3 style="margin-bottom: 16px;">${mode == 'create' ? 'Publishing checklist' : 'Editing checklist'}</h3>
                        </div>
                        <div class="ins-stack">
                            ...
                            <div class="ins-metric">
                                ...
                                <span>JPG, PNG, WEBP up to 5MB. Clear visuals attract more students.</span>
                            </div>
                            <div class="ins-metric">
                                <strong>Pricing</strong>
                                <span>Set to 0 for free courses, or set a competitive price.</span>
                            </div>
                            <div class="ins-metric">
                                <strong>${mode == 'edit' && course.status == 'Approved' ? 'Re-Approval' : 'Approval Flow'}</strong>
                                <span>${mode == 'edit' && course.status == 'Approved' ? 'Changes return course to pending review.' : 'After submit, admins will review your course before it goes live.'}</span>
                            </div>
                        </div>
                    </section>
                </div>
