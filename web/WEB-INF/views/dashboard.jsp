...
<div class="sv-layout">
    ...
    <main class="sv-main sd3-main sd3-dashboard">
        ...
        <div class="sd3-single-layout">
            ...
            <section class="sd3-welcome-banner" aria-labelledby="sd3DynamicGreeting">
                <div class="sd3-welcome-banner__content">
                    ...
                    <div class="sd3-welcome-banner__actions">
                        ...
                        <button type="button" class="sv-btn secondary-btn" id="btnCustomizeLayout" aria-expanded="false" aria-controls="sd3CustomizerPanel">
                ...
                <div class="sd3-welcome-banner__visual">
                    <div class="sd3-welcome-progress-card">
                        ...
                        <div class="sd3-progress-circle-wrapper">
                            <svg class="sd3-progress-circle" width="100" height="100" viewBox="0 0 100 100" aria-label="Overall progress indicator: ${overallProgress}%">
                                <circle class="sd3-progress-circle-bg" cx="50" cy="50" r="40" stroke-width="8" fill="transparent"/>
                                <circle class="sd3-progress-circle-fg" cx="50" cy="50" r="40" stroke-width="8" fill="transparent"
            ...
            <section class="sd3-customizer-panel" id="sd3CustomizerPanel" style="display: none;" aria-label="Layout customization options">
                <div class="sd3-customizer-panel__header">
                    <h4><i class="fas fa-sliders" aria-hidden="true"></i> Customize Your Dashboard Layout</h4>
                    <p>Drag the widgets by their handles to reorder, or toggle visibility using the switches below.</p>
                </div>
                <div class="sd3-customizer-panel__body">
                    ...
                    <div class="sd3-customizer-actions">
                        <button type="button" class="sv-btn secondary-btn" id="btnResetLayout"><i class="fas fa-rotate-left" aria-hidden="true"></i> Reset</button>
                        <button type="button" class="sv-btn primary" id="btnSaveLayout"><i class="fas fa-check" aria-hidden="true"></i> Done</button>
                    </div>
                </div>
            </section>

            <%-- Widget container for drag and drop sorting --%>
            <div class="sd3-widgets-container" id="sd3WidgetsContainer" role="list" aria-label="Draggable Dashboard Widgets">
                
                <%-- Widget: Enrolled Courses --%>
                <section class="sd3-widget sd3-courses-section" id="widget-courses" data-widget-id="widget-courses" role="listitem" aria-roledescription="draggable dashboard widget" tabindex="0">
                    <div class="sd3-widget-header-wrapper">
                        <div class="sd3-widget-drag-handle" title="Drag to reorder Continue Learning widget" aria-hidden="true">
                        ...
                        <div class="sd3-section-header">
                            ...
                            <a href="${pageContext.request.contextPath}/student/my-enrollments" class="sd3-header-link">View All <i class="fas fa-arrow-right-long" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    ...
                    <c:choose>
                                        ...
                                        <article class="sd3-course-card" data-status="${courseStatus}">
                                            <div class="sd3-course-card__banner">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <div class="sd3-course-card__banner-empty"><i class="fas fa-book-open" aria-hidden="true"></i></div>
                                                    </c:otherwise>
                                                </c:choose>
                                            ...
                                            <div class="sd3-course-card__body">
                                                ...
                                                <div class="sd3-course-card__progress-wrap-circular">
                                                    <div class="sd3-course-progress-circle-compact">
                                                        <svg class="sd3-compact-circle" width="48" height="48" viewBox="0 0 48 48" aria-label="Course progress: ${courseProgress}%">
                                                            <circle class="sd3-compact-circle-bg" cx="24" cy="24" r="18" stroke-width="4.5" fill="transparent"/>
                                                            <circle class="sd3-compact-circle-fg" cx="24" cy="24" r="18" stroke-width="4.5" fill="transparent"
                                                                    stroke-dasharray="113.1" stroke-dashoffset="113.1"
                                                                    data-progress="${courseProgress}"/>
                                                        </svg>
                                                        <div class="sd3-compact-circle-text">${courseProgress}%</div>
                                                    </div>
                                                    <div class="sd3-course-card__progress-meta">
                                                        <span>Course Progress</span>
                                                        <strong>Status: <c:out value="${course.completionStatus}"/></strong>
                                                    </div>
                                                </div>
                        ...
                        <c:otherwise>
                            <div class="sd3-empty-state">
                                <div class="sd3-empty-state__icon"><i class="fas fa-graduation-cap" aria-hidden="true"></i></div>
                ...
                <section class="sd3-widget sd3-sidebar-panel" id="widget-credentials" data-widget-id="widget-credentials" role="listitem" aria-roledescription="draggable dashboard widget" tabindex="0">
                    <div class="sd3-widget-header-wrapper">
                        <div class="sd3-widget-drag-handle" title="Drag to reorder Credentials widget" aria-hidden="true">
                            <i class="fas fa-grip-vertical"></i>
                        </div>
                    ...
                    <c:choose>
                        <c:when test="${certificatesCount > 0}">
                            <div class="sd3-credentials-box">
                                <div class="sd3-credentials-badge"><i class="fas fa-certificate" aria-hidden="true"></i></div>
                        ...
                        <c:otherwise>
                            <div class="sd3-credentials-box is-locked">
                                <div class="sd3-credentials-badge"><i class="fas fa-lock" aria-hidden="true"></i></div>
                ...
                <section class="sd3-widget sd3-sidebar-panel" id="widget-quicknav" data-widget-id="widget-quicknav" role="listitem" aria-roledescription="draggable dashboard widget" tabindex="0">
                    <div class="sd3-widget-header-wrapper">
                        <div class="sd3-widget-drag-handle" title="Drag to reorder Quick Management widget" aria-hidden="true">
                            <i class="fas fa-grip-vertical"></i>
                        </div>
...
<div id="sd3A11yLive" class="sr-only" aria-live="polite" style="position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0, 0, 0, 0); border: 0;"></div>
