...
<div class="sc-immersive-container">
    ...
    <header class="sc-immersive-header">
        <div class="sc-header-left">
            <a class="sc-back-link" href="${backUrl}">
        ...
        <div class="sc-header-center">
            <c:choose>
                <c:when test="${previewMode == true}">
                    <span class="sc-badge-ver" style="color: #f59e0b; background: rgba(245, 158, 11, 0.08); border-color: rgba(245, 158, 11, 0.2);">
                        <i class="fas fa-eye"></i> Certificate Template Preview
                    </span>
                </c:when>
                <c:otherwise>
        ...
        <div class="sc-header-right">
            ...
            <c:if test="${not empty certificate.verificationURL and previewMode != true}">
                <a class="sc-action-btn secondary-action" href="${certificate.verificationURL}" target="_blank">
    ...
    <main class="sc-immersive-main">
        <!-- Centered Academic Certificate Sheet -->
